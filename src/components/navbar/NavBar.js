        ...
        return (
            <nav>
                ...
                <div className={`overlay-menu ${isOpen ? 'open' : ''}`}>
                    ...
                    <AnchorLink href='#contact-wrapper'><li className="nav-item" onClick={() => this.btnHandler()}>Contact</li></AnchorLink>
                    </ul>
                </div>
                ...
                <div className="desktop-navbar">
                    <ul className="navbar-wrapper-expand">
                        ...
                        <AnchorLink href='#contact-wrapper'><li className="nav-item-expand">Contact</li></AnchorLink>
                    </ul>
                </div>
            </nav>
        )
